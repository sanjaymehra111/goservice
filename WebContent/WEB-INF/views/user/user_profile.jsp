...
reader.readAsDataURL(input.files[0]);
        ...
        <div class="test-1">  <br><br>
          <center><img src="/goservice/files/user_images/user1.png" class="user_image"></center>
          <img src="/goservice/files/user_images/camera_icon1.png" class="camera_icon1">
          ...
          <div class="col-md-10" style="text-align: center;">
            ...
            <input type="text" value="Sachin Maurya" name="user_name" class="text_field1" placeholder="user Name" readonly>
              &nbsp;&nbsp;&nbsp;&nbsp;
            <i class="fa fa-phone fa_text_fonts fa_text_fonts1"></i>
            <input type="text" value="8447484748" name="user_contact" class="text_field1" placeholder="user Contact" readonly>
              
            <br><br>
    
            <i class="fa fa-envelope fa_text_fonts fa_text_fonts1"></i>
            <input type="text" value="Sachin111@gmail.com" name="user_mail" class="text_field1"  placeholder="user Email"readonly>
              &nbsp;&nbsp;&nbsp;&nbsp;
            <i class="fa fa-map-marker fa_text_fonts fa_text_fonts1"></i>
            <input type="text" value="Uttam Nagar, New Delhi, India 110059" name="user_address" class="text_field1"  placeholder="user Address" readonly>
            <br><br><br>
