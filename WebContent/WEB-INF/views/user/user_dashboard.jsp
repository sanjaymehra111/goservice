    ...
    <aside class="side-nav" id="show-side-navigation1">
      ...
      <ul class="categories">
        ...
        <ul class="side-nav-dropdown">
            <li class="import_user hide_sidebar_button import_user_dashboard" pagename="home" textname="Dashboard"><a href="#">Home</a></li>
            <li class="import_user hide_sidebar_button" pagename="profile" textname="Profile"><a>Profile</a></li>
          </ul>
        </li>

        <li><i class="fa fa-support fa-fw"></i><a> My History</a>
          <ul class="side-nav-dropdown">
            <li class="import_user hide_sidebar_button" pagename="history" textname="History"><a>Complete Services</a></li>
          </ul>
        </li>

        <!-- <li ><i class="fa fa-users fa-fw"></i><a> Our team</a>
          <ul class="side-nav-dropdown">
            <li class="import_user hide_sidebar_button" pagename="create_team" textname="New Team Member"><a href="#">Create New Team</a></li>
            <li class="import_user hide_sidebar_button" pagename="team" textname="Team"><a href="#">All Team</a></li>
          </ul>
        </li> -->
