...
<div class="menu1">
    ...
    <div class="col-md-12 go-site-logo">
        <a href="../index.html" style="text-decoration: none"><img src="images/logo3.png" class="go-logo"></a>
  ...
  <div id="menu2">
        ...
        <div class="col-md-12 main-menu">
            <div class="col-md-12" id="site-menus-desktop">
                    <a href="../index.html" class="site-menu" style="text-decoration: none">Home</a>
                    <a href="../car-service.html" class="site-menu" style="text-decoration: none">Car Service</a>
                    <a href="../bike-service.html" class="site-menu" style="text-decoration: none">Bike Service</a>
                    <!-- <a href="about-us.html" class="site-menu" style="text-decoration: none">About us</a> -->
                    <a class="site-menu select_insurance" style="text-decoration: none">Insurance</a>
                    <div class="insurance_type"><br>
                        <a href="../car-insurance.html" style="text-decoration: none"><div class="site-menu" style="width: 100%; text-align: left;">Car</div></a><br>
                        <a href="../bike-insurance.html" style="text-decoration: none"><div class="site-menu" style="width: 100%; text-align: left">Bike</div></a><br>
                    </div>
                    <a href="provider_dashboard.html" class="site-menu" style="text-decoration: none; ">Partner</a>
                    <a href="user_dashboard.html" class="site-menu" style="text-decoration: none; ">User</a>
                    <a href="admin_dashboard.html" class="site-menu" style="text-decoration: none; ">Admin</a>
                    <a href="provider_login.html" class="site-menu" style="text-decoration: none; float: right;">Log In</a>
                 
            </div>
            <div class="site-logo">
                <!--<span><a href="index.html"><img class="main-logo" src="images/ample logo.png"></a></span>-->
            ...
            <div class="col-md-8 site-menus-mobile">
                    <div id="mySidenav" class="sidenav">
                            ...
                            <a href="provider_dashboard.html" class="site-menu-mobile" style="text-decoration: none; ">Dashboard</a>
                            <a href="user_dashboard.html" class="site-menu-mobile" style="text-decoration: none; ">USer</a>
                            <a href="admin_dashboard.html" class="site-menu-mobile" style="text-decoration: none; ">Admin</a>
                            <a href="../index.html" class="site-menu-mobile" style="text-decoration: none">Home</a>
                            <a href="../car-service.html" class="site-menu-mobile" style="text-decoration: none">Car Service</a>
                            <a href="../bike-service.html" class="site-menu-mobile" style="text-decoration: none">Bike Service</a>
                            <!-- <a href="about-us.html" class="site-menu-mobile" style="text-decoration: none">About us</a> -->
                            ...
                            <div class="insurance_type_mobile"><br>
                                <a href="../car-insurance.html" style="text-decoration: none;"><div class="site-menu-mobile" style="width: 100%; text-align: left;">Car</div></a><br>
                                <a href="../bike-insurance.html" style="text-decoration: none;"><div class="site-menu-mobile" style="width: 100%; text-align: left">Bike</div></a><br>
                            </div>
                            <!-- <a href="contact-us.html" class="site-menu-mobile" style="text-decoration: none">Contact</a> -->
                    </div>
            </div>
        </div>
        </div>
...
<div class="content2_1-main" style="background-color: rgb(240, 240, 240)">
  ...
  <div class="select-location" style="text-align: center">
    ...
    <div class="body1">
      ...
      <center><img src="images/delhi.png" style="width:150px; height: 150px;"></center>
      ...
      <br><center><img src="images/mumbai.png" style="width:130px; height: 130px;"></center>
      <hr style="border:solid 0.5px rgb(153, 187, 29); text-align: center; width: 50%;">
