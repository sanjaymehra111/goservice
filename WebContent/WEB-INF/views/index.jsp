...
<div class="service_select_vehicle" style="display: none">
...
<!-- <button onclick="getLocation()">Try It</button> -->
      ...
      <input type="text" maxlength="50"  name="service_user_name" class="fixbutton service_input_text service_user_name" placeholder="Name google address">
        <br><br>
        ...
        <input type="text" maxlength="100"  name="service_user_latlng_value" class="latlngvalue hidden">
        ...
        function LoadGoogleAddress(){
          //alert("Start");
            ...
            if(navigator.geolocation)
                ...
                // **----------Static Image--------------** //
                //  var img = new Image();
                //  img.src="/goservice/files/https://maps.googleapis.com/maps/api/staticmap?center="+lat+","+s+"&zoom=14&size=400x300&sensor=false&key=AIzaSyDnH5fBGp4ghjtu4qA-MM2gRjUApRcsn-A";
                //  $(".loc_output").html(img);
