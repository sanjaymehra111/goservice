    ...
    <aside class="side-nav" id="show-side-navigation1">
      ...
      <ul class="categories">
        ...
        <ul class="side-nav-dropdown">
            <li class="import_admin hide_sidebar_button import_admin_dashboard" pagename="home" textname="Dashboard"><a href="#">Home</a></li>
            <!-- <li class="import_admin hide_sidebar_button" pagename="profile" textname="Profile"><a>Profile</a></li> -->
          </ul>
        </li>

        <li><i class="fa fa-group fa-fw"></i><a> Group</a>
          <ul class="side-nav-dropdown">
            <li class="import_admin hide_sidebar_button" pagename="partner_group" textname="Partners List"><a>Partners</a></li>
            <li class="import_admin hide_sidebar_button" pagename="user_group" textname="User List"><a>Users</a></li>
          </ul>
        </li>
        
		<li ><i class="fa fa-dashboard fa-fw"></i><a> Masters</a>
          <ul class="side-nav-dropdown">
            <li class="import_admin hide_sidebar_button" pagename="create_car_master" textname="Car Master"><a>Car Master</a></li>
            <li class="import_admin hide_sidebar_button" pagename="create_bike_master" textname="Bike Master"><a>Bike Master</a></li>
            <li class="import_admin hide_sidebar_button" pagename="create_service_master" textname="Service Master"><a>Service Master</a></li>
            <li class="import_admin hide_sidebar_button" pagename="create_price_master" textname="Price Master"><a>Price Master</a></li>
          </ul>
        </li> 
        
         <li ><i class="fa fa-gear fa-fw"></i><a> Searvices</a>
          <ul class="side-nav-dropdown">
            <li class="import_admin hide_sidebar_button" pagename="create_car_service" textname="Car service"><a>Create Car service</a></li>
            <li class="import_admin hide_sidebar_button" pagename="create_bike_service" textname="Bike service"><a>Create Bike service</a></li>
            <li class="import_admin hide_sidebar_button" pagename="view_car_service" textname="Car Service List"><a>View Car Service </a></li>
            <li class="import_admin hide_sidebar_button" pagename="view_bike_service" textname="Bike Service List"><a>View Bike Service </a></li>
          </ul>
        </li> 
            ...
            <ul class="nav navbar-nav">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <!-- <li class="import_admin" pagename="profile" textname="Profile"><a href="#"><i class="fa fa-user-o fw"></i> My Profile</a></li>
