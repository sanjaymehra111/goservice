...
<div class="col-md-4 col-xs-6" style="text-align: center;">
            ...
            <input type="number" name="provider_range_from" class="text_field3 range_from" placeholder="Price Range From">
            <br><br>
</div>

<div class="col-md-4 col-xs-6" style="text-align: center;">
            <i class="fa fa-inr fa_text_fonts1 fa_text_fonts12"></i>
            <input type="number" name="provider_range_to" class="text_field3 range_to" placeholder="Price Range To">
            <br><br>
</div>
  
            <div class="col-md-12" style="text-align: center;">
<br>            <div class="service_buttons">
                <button class="service_edit_button2 service_save_button3">Create Price Range</button>
            </div>
          </div>
