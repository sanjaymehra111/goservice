...
<div class="col-md-4 col-xs-6" style="text-align: center;">
            ...
            <input type="text" name="provider_service_name" class="text_field3 bike_maker" placeholder="Bike Maker">
            <br><br>
</div>

<div class="col-md-4 col-xs-6" style="text-align: center;">
            <i class="fa fa-crosshairs fa_text_fonts1 fa_text_fonts12"></i>
            <input type="text" name="provider_service_name" class="text_field3 bike_model" placeholder="Bike Model">
            <br><br>
</div>
